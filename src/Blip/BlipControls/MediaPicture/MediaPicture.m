...
- (UIView *)loadViewFromNib {
    ...
    UINib *nib = [UINib nibWithNibName:@"MediaPicture" bundle:bundle];
...
-(void)selectedItem:(BlipTapGestureRecognizer*)sender {
    ...
    MediaPictureShow *v = [[MediaPictureShow alloc] init:_controller.view andUrlImage:_value.urlLink];
